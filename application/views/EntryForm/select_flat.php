                        ...
                        ?>
                          ...
                          <div class="col-md-3 mb-3">
                            <div class="card border-danger">
                                ...
                                <div class="card-body text-white" style="background-color: red ;">
                                        <span class="float-right summary_icon"> <i class="fa fa-home" style="color:black;"></i></span>
                                        <h5 style="color:black;"><b><i><?php echo "Flat No : ".$i; ?><span style="color:white; font-size:20px;"> (<?php echo $flats[$i]['flat_name']; ?>)</span></i></b></h5>
                                         <!-- <h6 style="color:black;"><b><i>Occupied </i></b></h6>  -->
                                        <h6 style="color:black; padding:0px;"><i><?php echo "Name : ".$flats[$i]['tenant_name']; ?> </i></h6>
                                        <h6 style="color:black; padding:0px;"><i><?php echo "No. of members : ".$flats[$i]['members']; ?> </i></h6>
                                        <h6 style="color:black; padding:0px;"><i><?php echo "Joining: ".$flats[$i]['joining_date']; ?> </i></h6>
                                    </div>
                                  </div> 

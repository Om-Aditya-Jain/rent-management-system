...
<main>
  ...
  <h4><?php echo $_SESSION['user']; ?></h4>
    ...
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li>
        <a href="<?php echo base_url('Invoice/print_invoice/'.$property_id.'/'.$month); ?>" class="nav-link text-white">Print Invoice</a>
      </li>
    </ul>
    <hr>
  </div>
  ...
  <div class="containe-fluid">
	<div class="row mt-3 ml-3 mr-3">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div style="font-style:italic; font-size: 23px;" ><b>View Invoice</b>    
                                
                    </div>
                    <hr>
                    <div style="display:flex; justify-content:center;">
                    <form action="<?php echo base_url("Invoice/view_invoice"); ?>" method="POST">
                    <input
                        id="month"
                        type="month"
                        name="month"
                    ...
                    <br>
                    <div class="row" style="height:50vh; overflow-x: hidden; overflow-y: auto;">
                    <table class="table table-striped table-hover table-bordered" style="width:90%" align="center">
                        ...
                        <tbody>
                            ...
                            <td style="text-align:center;"><?php echo "Flat No ".$p['flat_no']; ?></td>
                            <td style="text-align:center;"><?php echo date("F", strtotime($month))." ".date("Y", strtotime($month));; ?></td>
                            <td style="text-align:center;"><?php if(isset($p['timestamp'])){?>
                            ...
                            <td align="center">
                              ...
                              <a href="<?php echo base_url("Invoice/view_flat_invoice/").$property_id."/".$p['flat_no']."/".$month; ?>" class="btn btn-primary">View</a>
                             <?php } ?>
                            </td>
                            </tr>  
                            <?php $i++;} ?> 
